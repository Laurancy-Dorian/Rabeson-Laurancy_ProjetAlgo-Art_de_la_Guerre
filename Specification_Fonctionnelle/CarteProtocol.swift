...
public protocol CarteProtocol {
    ...
    public init(type_carte: String, puissance_attaque: Int, pv_defensif: Int, pv_offensif: Int, portee: [(Int, Int)]) throws
    ...
    public mutating func statut(statut: Int) throws
    ...
    public mutating func degats_subis(degats: Int)
    ...
    */
    ...
    public func attaque(carte_attaquee: CarteProtocol) throws -> Int
